...
ngram-count -text "${text_file}.txt" -order ${ngram_model} -sort -tolower -kndiscount -interpolate -lm "${output_file}_${ngram_model}-gram_smoothing-modified-kneser-ney.lm" -write${ngram_model} "${output_file}_${ngram_model}-gram_smoothing-modified-kneser-ney.count" -write-vocab "${output_file}_${ngram_model}-gram_smoothing-modified-kneser-ney.vocab" -memuse
