...
\begin{table}[t]
	...
	\extrarowsep = 0.47ex
	\centering
	\begin{tabu} to 0.22\textwidth { X[m,c] X[m,c] }
		\rowfont{\bfseries\itshape} N-gram & Total count \\
		\hline
		Unigram		&	 2487	\\
		Bigram		&	14140	\\
		Trigram		&	25071	\\
